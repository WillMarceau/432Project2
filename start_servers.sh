...
#test_server localhost 4725 localhost 4724 localhost 4723 localhost 4726 &
...
$SERVER localhost 4724 localhost 4721 localhost 4723 localhost 4725 localhost 4727 &
